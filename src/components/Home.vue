  ...
  <el-container class="home-container">
    ...
    <el-header>
      <router-link to="/welcome" style="text-decoration: none;">
        <div class="logo_tile">
        <img src="../assets/image/heima_logo.png" alt="" height="70px">
        <h2>后台管理系统</h2>
      </div>
      </router-link>
    ...
    <el-container>
      ...
      <el-aside :width="iscollapse ? '65px' : '200px'">
        ...
        <!-- menu 菜单  unique-opened保持一个子菜单的展开-->
        <el-menu
          default-active="2"
    ...
    <span style="color: gray; position: fixed; bottom: 0; right: 0;">课程</span>
  </el-container>
</template>
...
export default {
  ...
  methods: {
    // 点击按钮，退出登录
    logout() {
      //进行判断token 来防止用户重复提交表单
      // 清空保存的 token 信息 
      window.sessionStorage.removeItem('token')
      // 强制跳转到登录页面 /此时sessionStrrage已经没有了token令牌
