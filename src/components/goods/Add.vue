<template>
  <div>
    <!-- 提示条区域 closable属性决定是否可关闭 默认为true-->
    <el-alert title="添加商品信息" type="info" center show-icon :closable="false">
    </el-alert>
    <!-- 步骤条区域 element.ui自带 :active在js中定义初始值为0-->
    ...
    <el-form :model="addForm" :rules="addFormRules" ref="addFormRef" label-position="top">
      <el-tabs tab-position="left" v-model="activeName" :before-leave="beforeTabLeave">
        ...
        <el-tab-pane label="商品图片" name="3">
          ...
          <el-upload class="upload-demo" action="http://127.0.0.1:8888/api/private/v1/upload" :headers="uploadHeader" :on-preview="handlePreview" 
          :on-remove="handleRemove" list-type="picture" :on-success="uploadSuccess">
            <el-button size="small" type="primary">点击上传</el-button>
          </el-upload>
        </el-tab-pane>
        <el-tab-pane label="商品内容" name="4">
          <!-- 直接使用富文本编辑器，把它的内容，双向绑定到 addForm.goods_introduce 上利用element上的 引入了富文本编辑器-->
